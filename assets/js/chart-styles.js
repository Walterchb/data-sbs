...
export const QUICK_STYLES = {
  ...
  bloomberg: {
    name: "Bloomberg",
    note: "Alto contraste, acento naranja y cifras monoespaciadas.",
    titleFont: "sans",
    fontFamily: "mono",
    color: "#ff9f1a",
    ink: "#f3f3f3",
    ...
    grid: "#363636",
    muted: "#b0b0b0",
    colors: ["#ff9f1a", "#52c7e8", "#e77acb", "#98cb55"],
    rule: "#ff9f1a",
    background: "dark",
    weight: 700,
    height: 900,
  ...
  vox: {
    name: "Vox · editorial",
    note: "Amarillo, tinta oscura y títulos contundentes.",
    titleFont: "sans",
    fontFamily: "humanist",
    color: "#285c70",
    ink: "#242424",
    ...
    grid: "#ddd9c8",
    muted: "#686452",
    colors: ["#285c70", "#dc783e", "#8b709e", "#819b55"],
    rule: "#f4d83b",
    weight: 800,
    height: 900,
    width: 1200,
